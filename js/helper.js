 ...
 */
var HTMLheaderName = '<h3 id="name">%data%</h3>';
...
var HTMLbioPic = '<img src="%data%" class="biopic" alt="Pic of Sebastian Bauer">';
var HTMLwelcomeMsg = '<p class="welcome-message">%data%</p>';

var HTMLskillsStart = '<h3 id="skills-h3">Skills at a Glance:</h3><ul class="flex-box skills"></ul>';
var HTMLskills = '<li class="flex-item"><span>%data%</span></li>';

var HTMLworkStart = '<div class="work-entry"></div>';
var HTMLworkStart2 = '<div class="work-entry2"></div>';
...
var HTMLprojectStart2 = '<div class="project-entry2"></div>';
var HTMLprojectTitle = '<a href="%dataURL%">%data%</a>';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<p><br>%data%</p>';
var HTMLprojectImage = '<img src="%data%">';

var HTMLschoolStart = '<div class="education-entry"></div>';
var HTMLschoolStart2 = '<div class="education-entry2"></div>';
